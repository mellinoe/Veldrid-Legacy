...
namespace Veldrid.Graphics.OpenGLES
{
    public class OpenGLESRenderContext : RenderContext
    {
        ...
        private OpenGLESTextureBindingSlots TextureSlots => ((OpenGLESShaderResourceBindingSlots)base.ShaderResourceBindingSlots).TextureSlots;
        private OpenGLESShaderConstantBindingSlots ConstantSlots => ((OpenGLESShaderResourceBindingSlots)base.ShaderResourceBindingSlots).ConstantSlots;
    }
}
